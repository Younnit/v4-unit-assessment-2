...
//CODE HERE
foods.calories = foods.carbs*4 + foods.protein*4 + foods.fat
...
//CODE HERE
let person = {name: 'Gavin', age: 21, jobs: ['Programmer', 'Dog-Sitter', 'Teacher'], birthday: function(){this.age += 1}, favorites: {color: 'purple', number: 12, book: 'LOTR'}, kids: [{name: 'Jacob', age: 82}, {name: 'Bill', age: 99}]}
//////////////////////////////////PROBLEMS 13-14//////////////////////////////////
/*
